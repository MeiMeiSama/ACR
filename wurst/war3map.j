...
function CreateRegions takes nothing returns nothing
    ...
    set gg_rct_Team1WaveCenter=Rect(- 7360.0, 5952.0, - 6912.0, 6368.0)
    set gg_rct_Team1WaveRight=Rect(- 10048.0, 5824.0, - 9600.0, 6240.0)
    set gg_rct_Team1WaveLeft=Rect(- 7040.0, 9152.0, - 6592.0, 9568.0)
    set gg_rct_Team2WaveCenter=Rect(1824.0, 2176.0, 2272.0, 2592.0)
    set gg_rct_Team2WaveRight=Rect(4768.0, 4448.0, 5216.0, 4864.0)
    set gg_rct_Team2WaveLeft=Rect(4672.0, - 256.0, 5120.0, 160.0)
    set gg_rct_Team3WaveCenter=Rect(- 3488.0, - 3296.0, - 3040.0, - 2880.0)
    set gg_rct_Team3WaveRight=Rect(- 1408.0, - 5952.0, - 960.0, - 5536.0)
    set gg_rct_Team3WaveLeft=Rect(- 5888.0, - 5696.0, - 5440.0, - 5280.0)
    set gg_rct_CenterOfMap=Rect(- 3616.0, 2176.0, - 3040.0, 2720.0)
    set gg_rct_Team1Base=Rect(- 9856.0, 9120.0, - 9408.0, 9536.0)
    set gg_rct_Team2Base=Rect(4544.0, 2048.0, 4992.0, 2464.0)
    set gg_rct_Team3Base=Rect(- 3648.0, - 5760.0, - 3200.0, - 5344.0)
    set gg_rct_WaveBottomLeftCorner=Rect(- 9920.0, - 5440.0, - 9376.0, - 4992.0)
    set gg_rct_WaveBottomRightCorner=Rect(4544.0, - 5664.0, 4992.0, - 5216.0)
    set gg_rct_WaveTopRightCorner=Rect(4608.0, 9312.0, 5024.0, 9664.0)
    ...
    set gg_rct_Team1BaseArea=Rect(- 11168.0, 8256.0, - 8224.0, 10752.0)
    set gg_rct_Team2BaseArea=Rect(3520.0, 1344.0, 5888.0, 3552.0)
    set gg_rct_Team3BaseArea=Rect(- 4448.0, - 6656.0, - 2400.0, - 4352.0)
endfunction
